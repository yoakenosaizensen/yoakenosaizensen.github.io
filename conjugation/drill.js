...
function generateQuestion() {
  ...
  var questionText = {
    ...
    "non-て": "<span class='emphasis first'>remove</span> the <span class='emphasis'>て形</span> from the following",
    "potential": "<span class='first'>make</span> the following <span class='emphasis'>可能形</span>",
    "non-potential": "<span class='first'>make</span> the following <span class='emphasis'>non-可能形</span>",
    "imperative": "<span class='first'>make</span> the following <span class='emphasis'>命令形</span>",
    "non-imperative": "<span class='first'>make</span> the following <span class='emphasis'>non-命令形</span>",
    "causative": "<span class='first'>make</span> the following <span class='emphasis'>使役</span>",
    "non-causative": "<span class='first'>make</span> the following <span class='emphasis'>non-使役</span>",
    "passive": "<span class='first'>make</span> the following <span class='emphasis'>受動態</span>",
    "active": "<span class='first'>make</span> the following <span class='emphasis'>能動態</span>",
    "progressive": "<span class='first'>make</span> the following <span class='emphasis'>現在進行形</span>",
    "non-progressive": "<span class='first'>make</span> the following <span class='emphasis'>non-現在進行形</span>",
    "&apos;desire&apos;": "<span class='first'>convert</span> the following to the <span class='emphasis'>&apos;希望の助動詞&apos;</span> form",
    "&apos;non-desire&apos;": "<span class='first'>convert</span> the following to the <span class='emphasis'>&apos;non-希望の助動詞&apos;</span> form",
    "volitional": "<span class='first'>make</span> the following <span class='emphasis'>意向形</span>",
    "non-volitional": "<span class='first'>make</span> the following <span class='emphasis'>non-意向形</span>"
  };
